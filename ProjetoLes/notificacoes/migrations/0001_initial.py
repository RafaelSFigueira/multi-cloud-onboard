# Generated by Django 4.0.3 on 2022-04-29 15:30
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(db_column='ID', primary_key=True, serialize=False)),
                ('posicao', models.IntegerField(blank=True, db_column='Posicao', null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rua', models.CharField(blank=True, db_column='Rua', max_length=255, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('numeromesas', models.IntegerField(db_column='NumeroMesas')),
        ...
        migrations.CreateModel(
            name='FuncNotficaEnv',
            fields=[
                ('funcionarioid', models.OneToOneField(db_column='FuncionarioID', on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='notificacoes.funcionario')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('notificacaoid', models.OneToOneField(db_column='NotificacaoID', on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='notificacoes.notificacao')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('produtoid', models.OneToOneField(db_column='ProdutoID', on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='notificacoes.produto')),
            ],
            options={
        ...
        migrations.CreateModel(
            name='ReservaMesa',
            fields=[
                ('reservaid', models.OneToOneField(db_column='ReservaID', on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='notificacoes.reserva')),
            ],
            options={
