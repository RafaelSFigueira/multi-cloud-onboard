    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rua', models.CharField(blank=True, db_column='Rua', max_length=100, null=True)),
                ...
                ('abertura_tarde', models.TimeField(blank=True, db_column='Abertura_Tarde', null=True)),
                ('fecho_tarde', models.TimeField(blank=True, db_column='Fecho_Tarde', null=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('notificacaoid', models.OneToOneField(db_column='NotificacaoID', on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='cozinha.notificacao')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('produtoid', models.OneToOneField(db_column='ProdutoID', on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='cozinha.produto')),
            ],
            options={
        ...
        migrations.CreateModel(
            name='ReservaMesa',
            fields=[
                ('reservaid', models.OneToOneField(db_column='ReservaID', on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='cozinha.reserva')),
            ],
            options={
