...
class Codigos_postais_parcial(models.Model):
    id = models.AutoField(db_column='ID', primary_key=True)  # Field name made lowercase.
    cod_distrito = models.IntegerField(db_column='cod_distrito')  # Field name made lowercase.
    cod_concelho = models.IntegerField(db_column='cod_concelho')  # Field name made lowercase.
    nome_localidade = models.CharField(db_column='nome_localidade', max_length=50, blank=True, null=True)  # Field name made lowercase.
    num_cod_postal = models.IntegerField(db_column='num_cod_postal')  # Field name made lowercase.
    ext_cod_postal = models.IntegerField(db_column='ext_cod_postal')  # Field name made lowercase.
    desig_postal = models.CharField(db_column='desig_postal', max_length=50, blank=True, null=True)  # Field name made lowercase.
...
class Concelhos(models.Model):
    ...
    cod_distrito = models.IntegerField(db_column='cod_distrito')  # Field name made lowercase.
    cod_concelho = models.IntegerField(db_column='cod_concelho')  # Field name made lowercase.
    nome_concelho = models.CharField(db_column='nome_concelho', max_length=50, blank=True, null=True)  # Field name made lowercase.
...
class Distritos(models.Model):
    id = models.AutoField(db_column='ID', primary_key=True)  # Field name made lowercase.
    cod_distrito = models.IntegerField(db_column='cod_distrito')  # Field name made lowercase.
    nome_distrito = models.CharField(db_column='nome_distrito', max_length=50, blank=True, null=True)  # Field name made lowercase.
...
class FuncionarioNotificacao(models.Model):
    ...
    nomerestaurante = models.CharField(db_column='Nome restaurante', max_length=30, blank=True, null=True)  # Field name made lowercase.
...
class Restaurante(models.Model):
    ...
    funcionarioid = models.ForeignKey(Funcionario, on_delete=models.CASCADE, db_column='FuncionarioID', blank=True, null=True)
