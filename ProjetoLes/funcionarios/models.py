...
class FuncionarioNotificacao(models.Model):
    id = models.AutoField(db_column='ID', primary_key=True)  # Field name made lowercase.
    funcionarioid_recetor = models.ForeignKey(Funcionario, on_delete=models.CASCADE, db_column='FuncionarioID_Recetor', blank=True, null=True)  # Field name made lowercase.
