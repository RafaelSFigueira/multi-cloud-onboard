# Generated by Django 4.0.3 on 2022-04-22 16:09
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('limpeza', models.IntegerField(blank=True, db_column='Limpeza', null=True)),
                ('ocupada', models.IntegerField(blank=True, db_column='Ocupada', null=True)),
                ('reservada', models.IntegerField(blank=True, db_column='Reservada', null=True)),
            ],
            options={
                'db_table': 'mesa',
                'managed': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('produtoid', models.OneToOneField(db_column='ProdutoID', on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='funcionarios.produto')),
            ],
            options={
        ...
        migrations.CreateModel(
            name='ReservaMesa',
            fields=[
                ('reservaid', models.OneToOneField(db_column='ReservaID', on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='funcionarios.reserva')),
            ],
            options={
